          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                <div className="glass-card p-4 rounded-xl border border-white/60 shadow-sm hover-lift">
            ...
            <div className="lg:col-span-6">
              <div className="glass-card rounded-2xl p-2 shadow-xl border border-white/60 overflow-hidden">
                <img
